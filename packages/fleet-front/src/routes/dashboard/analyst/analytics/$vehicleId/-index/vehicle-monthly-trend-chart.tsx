...
function VehicleMonthlyTrendChartSkeleton({
	className,
	...props
	...
	return (
		<Card className={cn("pb-0", className)} {...props}>
			<CardHeader className="border-b flex-row items-start justify-between">
				...
				<CardDescription>Profit and expenses trends over time</CardDescription>
				<CardAction>
					<DropdownMenu>
						<DropdownMenuTrigger
							render={
			...
			<CardContent className="px-2 sm:p-6" ref={chartContainerRef}>
				<ChartContainer
					config={chartConfig}
...
export function VehicleMonthlyTrendChart({
	...
	return (
		<Suspense
			fallback={
				<VehicleMonthlyTrendChartSkeleton className={className} {...props} />
			}
		>
